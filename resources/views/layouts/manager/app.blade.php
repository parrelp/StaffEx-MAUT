    ...
    <div class="sidebar ms-16 grid">
        ...
        <div class="menu flex flex-col items-center justify-start gap-4 py-16">
            ...
            <div class="tooltip-container">
                <a href="{{ route('manager.dashboard') }}"><svg  xmlns="http://www.w3.org/2000/svg"  width="43"  height="43"  viewBox="0 0 24 24"  fill="none"  stroke="white"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-layout-dashboard {{ Route::is('manager.dashboard') ? 'active' : '' }}"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 4h4a1 1 0 0 1 1 1v6a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-6a1 1 0 0 1 1 -1" /><path d="M5 16h4a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-2a1 1 0 0 1 1 -1" /><path d="M15 12h4a1 1 0 0 1 1 1v6a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-6a1 1 0 0 1 1 -1" /><path d="M15 4h4a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1v-2a1 1 0 0 1 1 -1" /></svg></a>
                {{-- <button class="tooltip-trigger">Hover Me</button> --}}
                <div class="tooltip font-semibold">Dashboard</div>
            </div>

            <div class="tooltip-container">
                 <a href="{{ route('manager.candidate-list.index') }}"><svg  xmlns="http://www.w3.org/2000/svg"  width="43"  height="43"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-users menu-icon {{ Route::is('manager.candidate-list.index') ? 'active' : '' }}"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg></a>
                {{-- <button class="tooltip-trigger">Hover Me</button> --}}
                <div class="tooltip font-semibold">Candidates</div>
            </div>

            <div class="tooltip-container">
                <a href="{{ route('manager.candidate-rank.index') }}"><svg  xmlns="http://www.w3.org/2000/svg"  width="43"  height="43"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-certificate-2 menu-icon {{ Route::is('manager.candidate-rank.index') ? 'active' : '' }}"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 15m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /><path d="M10 7h4" /><path d="M10 18v4l2 -1l2 1v-4" /><path d="M10 19h-2a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-2" /></svg></a>
                {{-- <button class="tooltip-trigger">Hover Me</button> --}}
                <div class="tooltip font-semibold">Ranking</div>
            </div>
        ...
        <div class="manager-criteria flex flex-col items-center justify-start gap-6 py-8">
            <div class="tooltip-container">
                <a href="{{ route('manager.history-rank.index') }}"><svg  xmlns="http://www.w3.org/2000/svg"  width="43"  height="43"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="1.5"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-history menu-icon {{ Route::is('manager.history-rank.index') ? 'active' : '' }}"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 8l0 4l2 2" /><path d="M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5" /></svg></a>
                {{-- <button class="tooltip-trigger">Hover Me</button> --}}
                <div class="tooltip font-semibold">History Rank</div>
            </div>
