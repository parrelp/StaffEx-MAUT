...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('candidate_criteria_averages')) {
            Schema::create('candidate_criteria_averages', function (Blueprint $table) {
                $table->id('id_avg');
    ...
    {
        Schema::dropIfExists('candidate_criteria_averages');
    }
};
